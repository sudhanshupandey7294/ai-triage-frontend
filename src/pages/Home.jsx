...
function Home() {
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Navbar */}
      <nav className="bg-blue-800 text-white px-6 py-4 flex flex-wrap justify-between items-center shadow-md sticky top-0 z-50">
        <h1 className="text-2xl font-bold tracking-wide">AI Triage System</h1>
        <ul className="flex flex-wrap gap-4 text-sm sm:text-base mt-2 sm:mt-0">
          <li>
            <Link to="/" className="hover:text-blue-300 transition">Home</Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/login" className="bg-white text-blue-800 px-4 py-1.5 rounded hover:bg-blue-100 font-semibold transition">
              Login
            </Link>
          </li>
        </ul>
      ...
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center flex-1 text-center px-4 sm:px-6 py-16 sm:py-24 bg-blue-50">
      ...
      {/* Features Section */}
      <section id="features" className="py-20 px-4 sm:px-6 bg-white text-center">
        <h3 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-12">Key Features</h3>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="bg-blue-50 p-6 rounded-lg shadow hover:shadow-lg transition">
            <h4 className="text-xl font-semibold mb-2 text-blue-800">Symptom Analysis</h4>
            <p className="text-gray-600">AI analyzes input symptoms and vitals for accurate triage decisions.</p>
          </div>
          <div className="bg-blue-50 p-6 rounded-lg shadow hover:shadow-lg transition">
            <h4 className="text-xl font-semibold mb-2 text-blue-800">Urgency Scoring</h4>
            <p className="text-gray-600">Get Low / Moderate / Critical scoring with visual breakdown.</p>
          </div>
          <div className="bg-blue-50 p-6 rounded-lg shadow hover:shadow-lg transition">
            <h4 className="text-xl font-semibold mb-2 text-blue-800">Visual Insights</h4>
            <p className="text-gray-600">Bar or radar charts help visualize triage levels in real time.</p>
          </div>
        </div>
      </section>
      ...
      {/* About Section */}
      <section id="about" className="py-20 px-4 sm:px-6 bg-blue-800 text-white text-center">
        <h3 className="text-3xl sm:text-4xl font-bold mb-6">About Us</h3>
